...
head = Label(root,text="TIC-TAC-TOE",fg="black",font=("Arial",20))
head.pack()
...
start = Button(root,text="START",fg="green",font=("Ubuntu",15),command=Start)
start.place(x=107,y=410)
...
restart = Button(root,text="Restart",fg="black",width = 10,height=1,font=("Courier",10,"bold"),command = Restart)
##restart.place(x=105,y=470)
restart.place(x=1000,y=1000)
